...
#define SYSTEM_CLOCK     8000000UL // 8 MHz
#define SYSTICK_US_DIVISOR (SYSTEM_CLOCK / 1000000UL) // Divisor for 1 microsecond delay
...
#define RCC_ADC2_Reset()	(RCC->APB2RSTR &= ~(1<<10))
...
#define NVIC_IRQ18_ADC_Disable()			(NVIC_ICER0 |= 1<<218)
